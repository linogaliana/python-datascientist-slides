...
slide-number: true
footer: |
  **_Python pour la data science_, ENSAE & ENSAI (Retour sur [pythonds.linogaliana.fr](https://pythonds.linogaliana.fr/))**
...
* Pouvoir utiliser `Python` {{< fa brands python >}} pour l'[**ensemble du processus de valorisation**]{.orange} des données :
    ...
    + Manipuler ;
    + Visualiser ;
    + <del>Modéliser</del> *(Modélisation au S2)* ;
...
* Cours dure [__15h__]{.orange} avec des __séances de 3h__ ;
...
Vous devez utiliser le [`SSPCloud` https://datalab.sspcloud.fr](https://datalab.sspcloud.fr/home) pour les TD. 
...
::: {.column width="45%"}
[![](pandaqr2.png){width=80%}](https://pythonds.linogaliana.fr/content/manipulation/02_pandas_intro.html)
...
::: {.column width="45%"}
[![](onyxia-qrcode4.png){width=80%}](https://www.sspcloud.fr/formation)
...
* Exigence de [__reproductibilité__]{.orange}
    + Projet utilisant des __sources *open data*__ ou scrappant des sites publics (⚠️ scraping = risque de galère) ; 
...
* __Approfondir__ des aspects du cours: 
    + [__Trois dimensions__]{.orange} doivent être présentes dans le projet: récupération, manipulation, visualisation ;
