...
* Cours dure [__18h__]{.orange} avec des __séances de 3h__ ;
...
* Validation avec un [__projet de fin de semestre__]{.orange} et un [__devoir maison intermédiaire__]{.orange}
...
<!--- retiré pour ENSAI où pas de NLP 
